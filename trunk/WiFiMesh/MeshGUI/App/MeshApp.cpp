...
#include "../MeshViews/MeshViewMessagesList.h"
...
void MeshApp::createDocks()
{
	...
	QDockWidget* dockMessages = createDock(tr("Messages"), new MeshViewMessagesList(this));
	...
	tabifyDockWidget(dockStations, dockMessages);
